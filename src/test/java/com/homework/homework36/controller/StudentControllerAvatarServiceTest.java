...
public class StudentControllerAvatarServiceTest {
    ...
    public void shouldCorrectlyGetAvatars() throws Exception{
        ...
        ResponseEntity<String> response = testRestTemplate.getForEntity("/student/avatars?pageNum=1&pageSize=2", String.class, pageNum, pageSize);
